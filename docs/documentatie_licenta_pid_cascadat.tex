...
Valorile de reglare prezentate în continuare au fost obținute înaintea separării
complete dintre starea de reacție și starea exactă de evaluare și sunt păstrate
ca rezultate preliminare ale alegerii câștigurilor. Matricea formală de
benchmark va fi repetată, iar tabelele finale vor folosi erorile calculate din
\texttt{/ground\_truth/odom}. O probă de integrare pe dreapta de \SI{5}{m} a
confirmat funcționarea noii arhitecturi: eroarea finală raportată de EKF a fost
\SI{0.079}{m}, eroarea finală fizică a fost \SI{0.046}{m}, iar eroarea de
localizare aliniată temporal a fost \SI{0.020}{m} RMS și \SI{0.026}{m} maxim.
Aceste valori verifică separarea fluxurilor, dar nu înlocuiesc repetarea
benchmark-ului complet.
...
frontierele temporale ale perturbației au fost verificate automat. Cele 13 ținte
CTest ale celor două pachete se încheie fără erori sau eșecuri. Instrumentul
ROS omite 15 verificări statice cppcheck deoarece versiunea instalată este
