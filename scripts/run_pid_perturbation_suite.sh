...
#
# Optional:
#   PERTURBATION_GUI=true PERTURBATION_SCENARIOS="nominal angular_pulse" ...
...
SCENARIOS="${PERTURBATION_SCENARIOS:-nominal angular_pulse angular_constant left_wheel_loss command_delay localization_noise}"
