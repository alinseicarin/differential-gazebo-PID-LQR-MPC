"""Launch PID with controller-independent command and odometry fault paths."""
...
def generate_launch_description():
    ...
    command_injector = Node(
        ...
        parameters=[{
            ...
            'left_wheel_effectiveness': _float(
                'left_wheel_effectiveness'
            ),
            'right_wheel_effectiveness': _float(
                'right_wheel_effectiveness'
            ),
